...
fn interactive_add_account() -> error::Result<()> {
    ...
    let broker_config = match broker_type {
        ...
        "ccxt" => {
            ...
            let passphrase: String = Input::new()
                .with_prompt("Passphrase (OKX only, leave empty otherwise)")
                .default(String::new())
                .interact_text()
