...
fn apply_env_overrides_with(
    ...
    for account in &mut cfg.accounts {
        ...
        let BrokerConfig::Ccxt(ref mut ccxt) = account.broker_config;
...
# Use sandbox = true for paper trading against exchange testnets.
...
mod tests {
    ...
    fn load_from_toml_file() {
        ...
        assert_eq!(cfg.accounts[0].id, "binance-sandbox");
    }
    ...
    fn env_vars_override_ccxt_secrets() {
        ...
        let BrokerConfig::Ccxt(ref ccxt) = cfg.accounts[0].broker_config;
